...
if (document.querySelector(".column-block__slider_articles")) {
  function resizeArticles() {
    if (
      document.querySelectorAll(".column-slider__slide_articles").length > 3
    ) {
      document
        .querySelector(".page__column-block_articles")
        .classList.add("_slider");
    } else {
      document
        .querySelector(".page__column-block_articles")
        .classList.add("_column");
    }

    if (
      window.innerWidth < 768.2 &&
      document.querySelectorAll(".column-slider__slide_articles").length > 2
    ) {
      document
        .querySelector(".page__column-block_articles")
        .classList.add("_slider");
    ...
    if (
      window.innerWidth < 375.2 &&
      document.querySelectorAll(".column-slider__slide_articles").length > 1
    ) {
      document
        .querySelector(".page__column-block_articles")
        .classList.add("_slider");
...
if (document.querySelector(".column-block__slider_white-papers")) {
  function resizeWhitePaper() {
    if (
      document.querySelectorAll(".column-slider__slide_white-papers").length > 3
    ) {
      document
        .querySelector(".page__column-block_white-papers")
        .classList.add("_slider");
    } else {
      document
        .querySelector(".page__column-block_white-papers")
    ...
    if (
      window.innerWidth < 768.2 &&
      document.querySelectorAll(".column-slider__slide_white-papers").length > 2
    ) {
      document
        .querySelector(".page__column-block_white-papers")
        .classList.add("_slider");
    ...
    if (
      window.innerWidth < 375.2 &&
      document.querySelectorAll(".column-slider__slide_white-papers").length > 1
    ) {
      document
        .querySelector(".page__column-block_white-papers")
        .classList.add("_slider");
...
const largeSlider = () => {
  let largeSliders = document.querySelectorAll(
    ".security-tabs-content__slider"
  );
  let prevArrow = document.querySelectorAll(
    ".security-tabs-content__arrow.swiper-button-prev"
  );
  let nextArrow = document.querySelectorAll(
    ".security-tabs-content__arrow.swiper-button-next"
  );
  let pagination = document.querySelectorAll(
    ".security-tabs-content__pagination.swiper-pagination"
  );
  ...
  function preset() {
    sliders.forEach((slider) => {
      if (window.innerWidth > 992.2) {
        if (
          slider.querySelectorAll(".security-tabs-content__slide").length <= 4
        ) {
      ...
      if (window.innerWidth < 992.2) {
        if (
          slider.querySelectorAll(".security-tabs-content__slide").length <= 3
        ) {
          slider.parentElement.classList.add("_column");
        } else {
          slider.parentElement.classList.remove("_column");
      ...
      if (window.innerWidth < 768.2) {
        if (
          slider.querySelectorAll(".security-tabs-content__slide").length <= 2
        ) {
          slider.parentElement.classList.add("_column");
        } else {
          slider.parentElement.classList.remove("_column");
      ...
      if (window.innerWidth < 480.2) {
        if (
          slider.querySelectorAll(".security-tabs-content__slide").length <= 1
        ) {
          slider.parentElement.classList.add("_column");
        } else {
          slider.parentElement.classList.remove("_column");
...
function myTabs() {
  if (document.querySelector("[data-tabs]")) {
    const tabs = document
      ...
      .querySelectorAll("[data-tab]:first-child");
    ...
    document.addEventListener("click", (e) => {
      ...
      if (elementTarget.closest("[data-tab-btn]")) {
        ...
        elementTarget
          .closest("[data-tabs]")
          .querySelector(`${modernAtt}`).style.display = "block";
        setTimeout(() => {
          elementTarget
            .closest("[data-tabs]")
            .querySelector(`${modernAtt}`).style.opacity = "1";
        }, 300);
        ...
        inner.forEach((elem) => {
          document.addEventListener("click", function (e) {
            ...
            if (elementTarget.closest(".security-tabs__buttons-item")) {
              if (
                elem.querySelector(".functional-tabs-right__item") &&
                elem.querySelector(".functional-tabs-left__button")
              ) {
                const childrenContent = elem.querySelector(
                  ".functional-tabs-right__item"
                );
                const childrenButton = elem.querySelector(
                  ".functional-tabs-left__button"
                );

                if (
                  !childrenContent.classList.contains("_active") &&
                  !childrenButton.classList.contains("_active")
                ) {
  ...
  items.forEach((item) => {
    window.addEventListener("resize", function () {
      item.querySelectorAll(".column-slider__image").forEach((slide) => {
        ...
        document
          .querySelectorAll(".column-slider__arrows")
          .forEach((arrows) => {
